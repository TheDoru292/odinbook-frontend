export async function sendFriendReq(userId) {
  ...
  const friendRequest = await fetch(
    `https://odinbook-backend-zoih.onrender.com/api/user/${userId}/friend/request/`,
    {
      method: "POST",
      headers: {
...
export async function denyFriendReq(reqId) {
  ...
  const friendRequest = await fetch(
    `https://odinbook-backend-zoih.onrender.com/api/user/${id}/friend/request/${reqId}`,
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
...
export async function removeFriend(userId) {
  ...
  const friendRequest = await fetch(
    `https://odinbook-backend-zoih.onrender.com/api/user/${id}/friend/${userId}`,
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
